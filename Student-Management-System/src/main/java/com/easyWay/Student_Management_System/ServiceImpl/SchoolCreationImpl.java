...
public class SchoolCreationImpl implements SchoolCreationService {
    ...
    public String saveSchool(SchoolCreationDto details) {
        ...
        users.setPermission("{\"student\":{\"studentAttendance\":false,\"studentAttendanceEdit\":false,\"studentAttendenceManagement\":false,\"studentFees\":false,\"studentAttendanceEditSave\":false,\"studentRegistrationController\":false,\"studentAttendanceShow\":false,\"studentFeesController\":false,\"studentFeesForm\":false,\"studentFeesDetails\":false,\"studentReportForm\":false,\"studentReport\":false,\"studentDetails\":false},\"faculty\":{\"facultySalaryDetails\":false,\"facultySalaryController\":false,\"facultyAttendanceEditSave\":false,\"facultyAttendanceEdit\":false,\"facultyAttendanceShow\":false,\"facultyAttendanceSave\":false,\"facultyRegistrationForm\":false,\"facultyDetails\":false},\"finance\":{\"adminFees\":false,\"feesController\":false,\"permission\":false},\"notification\":{\"createNotification\":false,\"notificationList\":false,\"holidayFormController\":false,\"notificationController\":false},\"subject\":{\"saveSubjectsToClasses\":false,\"classSubjectShow\":false}}");
